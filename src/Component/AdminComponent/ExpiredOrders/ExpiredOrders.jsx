            ...
            <div className="min-w-full">
              <table className="table table-bordered text-center shadow-sm w-full">
                <thead className="bg-white border">
                  <tr>
                    <th className="px-2 py-3 text-xs sm:text-sm md:text-base">الرقم المعرف</th>
                    <th className="px-2 py-3 text-xs sm:text-sm md:text-base">الوقت</th>
                    <th className="px-2 py-3 text-xs sm:text-sm md:text-base">العنوان</th>
                  </tr>
                </thead>
                <tbody>
                  {loading ? (
